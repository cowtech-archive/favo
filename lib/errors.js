...
function buildError(statusCode, description, properties = {}, required = [], additionalProperties = false) {
    ...
    return {
        ...
        description,
        properties: Object.assign({ statusCode: { type: 'number', description: 'The error code', enum: [statusCode], example: statusCode }, error: { type: 'string', description: 'The error title', enum: [error], example: error }, message: {
                type: 'string',
