...
exports.Spec = exports.omitFromSchema = exports.parametersSections = void 0;
...
class Spec {
    ...
    addRoutes(routes) {
        ...
        for (const route of apiRoutes) {
            const schema = ((_a = route.schema) !== null && _a !== void 0 ? _a : {});
            const config = ((_b = route.config) !== null && _b !== void 0 ? _b : {});
    ...
    addFolder(folder) {
        ...
        for (const file of glob_1.sync(`${folder}/**/*(*.ts|*.js)`)) {
            ...
            for (const route of routes) {
                if (route) {
                    const models = (_a = route === null || route === void 0 ? void 0 : route.config) === null || _a === void 0 ? void 0 : _a.models;
                    const securitySchemes = (_b = route === null || route === void 0 ? void 0 : route.config) === null || _b === void 0 ? void 0 : _b.securitySchemes;
                    if (models) {
    ...
    parseParameters(schema) {
        ...
        for (const [section, where] of Object.entries(exports.parametersSections)) {
            ...
            // For each property
            for (const [name, spec] of Object.entries(((_b = specs.properties) !== null && _b !== void 0 ? _b : {}))) {
                params.push({
                    name,
                    in: where,
